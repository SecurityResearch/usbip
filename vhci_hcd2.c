...
#define DRIVER_DESC "USB/IP 'Virtual' Host Controller (VHCI) Driver for USB 2.0"
...
static const char driver_name[] = "vhci_hcd2";
static const char driver_desc[] = "USB/IP Virtual Host Controller USB 2.0 ";
